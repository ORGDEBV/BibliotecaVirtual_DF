...
import vb.dao.reporteDao;
import vb.entidad.reporteUsuarioDocumental;
import vb.dao.usuarioDao;
...
public class reporteBean implements Serializable {
    ...
    public List<reporteUsuarioDocumental> getListRUDoc() {
        sumaDocumentales = 0;
        listRUDoc = new ArrayList<reporteUsuarioDocumental>();
        DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        String date = dateFormat.format(fechaReporte);
    ...
    public List<reporteUsuarioDocumental> getObjPT() {
        ...
        int idUsuario = (Integer) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("personalIdUsuario");
        sumaDocumentales = 0;
        objPT = new ArrayList<reporteUsuarioDocumental>();
    ...
    public void crearModeloLineal() {
        ...
        ArrayList<Object[]> listaUsuarios = rDao.listaUsusariosMensual(ianio, idBiblioteca);
        ArrayList<Object[]> listaDatos = rDao.listaConsolidadoMensual(ianio, idBiblioteca);
        int max =rDao.conteoMaxMensual(ianio, idBiblioteca);        
...
//        pieModel.set("nuevos", 10);
//        pieModel.set("modificados", 90);
        pieModel.setExtender("skinPie");
