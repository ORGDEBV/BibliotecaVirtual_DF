...
//        }
        ...
        for (Object[] dat : result) {
            if(dat[0].toString().equals("1")){
                n = 1;
                 logTablaDao.registrarLogTabla(new LogTabla("BV", "PERSONAL_BIBLIOTECA", "", "1", String.valueOf(idUsuario)));
                 logTablaDao.registrarLogTabla(new LogTabla("BV", "USUARIO", "", "1", String.valueOf(idUsuario)));
            }
        }
...
//    public String crearPersonalBiblioteca(Personal p) {
//        String msg = "no registro";
//
...
//
    ...
    public int eliminarEntidad(int codigo,int idUsuario) {
        ...
        if (result != null) {
            n = 1;
             logTablaDao.registrarLogTabla(new LogTabla("BV", "PERSONAL_BIBLIOTECA", "", "3", String.valueOf(idUsuario)));
    ...
    public int actualizarEntidad(Personal p,int idUsuario) {
      ...
      if (p.isBoolActivo()) {
        ...
        if (result != null) {
            n = 1;
             logTablaDao.registrarLogTabla(new LogTabla("BV", "PERSONAL_BIBLIOTECA", "", "2", String.valueOf(idUsuario)));
